    ...
    <form class="" action="TaxPayer.php" method="post">
      <div class="site-section">
        <div class="container">
             ...
             <?php
             $query=mysqli_query($con,"select * from tax_form");
             echo "";
             if($query)
             {
               while ($row=mysqli_fetch_array($query)) {
                 ...
                 <tr>
                    ...
                    <td> <a style="text-decoration:none" href="Move_Admin.php?tax_id=<?php echo $row['Tax_ID']; ?>"><?php echo $row['Status'] ?></a> </td>
