...
if(isset($_SESSION['user']))
{
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     <form class="" action="Move_Admin_Handler.php" method="post">
       <div class="site-section">
         <div class="container">
              ...
              <?php
              $query=mysqli_query($con,"select * from tax_form where `Email`='$email'");
              echo "";
              if($query)
              {
                while ($row=mysqli_fetch_array($query)) {
                  ...
                  <tr>
                     ...
                     <tr>
                       <td> <b>&nbsp&nbspStatus: <?php echo $row['Status']; ?></b> </td>
                     </tr>
                    ...
                    <!--  <td>
                        <select class="form-control" name="status" id="status">
                          ...
                          <option value="Forwarded">Forward to Admin</option>
